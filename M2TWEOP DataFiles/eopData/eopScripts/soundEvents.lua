---Enum with a list of types of sound events. For playGameSound function. 
---@enum SOUND_EVENTS
SOUND_EVENTS = {
    BUTTON_DOWN                                         = 0,
    BUTTON_UP                                           = 1,
...
---Enum with a list of types of character voices events. For playCharacterVoice function. 
---@enum VOICES_EVENTS
VOICES_EVENTS = {
	AMBUSHED                                            = 0,
	ATTACKED_ENEMY                                      = 1,
	ATTACKING                                           = 2,
	BATTLE_LOST_RETREAT                                 = 3,
	BATTLE_WON                                          = 4,
	BUILDING_FORT                                       = 5,
	BUILDING_TOWER                                      = 6,
	DEATH_CRY                                           = 7,
    ...
    MARRY_GENERAL                                       = 18,
    MOVEMENT_ACQUIRE                                    = 19,
	MOVEMENT_DENOUNCE                                   = 20,
	MOVEMENT_BLACKOPS                                   = 21,
	MOVEMENT_COMPLETED                                  = 22,
	MOVEMENT_DIPLOMACY                                  = 23,
	MOVEMENT_DISEMBARK                                  = 24,
	MOVEMENT_EMBARK                                     = 25,
    MOVEMENT_NONTRADABLE                                = 26,
	MOVEMENT_ORDERED                                    = 27,
	MOVEMENT_ORDERED_ILLEGAL_MOVE                       = 28,
    MOVEMENT_RESOURCE                                   = 29,
	PLACED_FOR_AMBUSH                                   = 30,
	PURSUE_RETREATING_ARMY                              = 31,
	SELECTED                                            = 32,
    SELECT_ALLY                                         = 33,
    SELECT_ENEMY                                        = 34,
    SELECT_NEUTRAL                                      = 35,
	SETTLEMENT_CAPTURE_CELEBRATION                      = 36,
	SIEGE_BEGUN                                         = 37,
	SIEGE_BESIEGED                                      = 38,
	SIEGE_LIFTED                                        = 39,
	SIEGE_ONGOING                                       = 40,
	UNITS_DISEMBARK                                     = 41,
	UNITS_EMBARK                                        = 42,
	INTRO_DEMEANOUR_ALLY                                = 43,
	INTRO_DEMEANOUR_NEUTRAL                             = 44,
	INTRO_DEMEANOUR_ENEMY                               = 45,
	RECEIVING_DEMEANOUR_ALLY                            = 46,
	RECEIVING_DEMEANOUR_NEUTRAL                         = 47,
	RECEIVING_DEMEANOUR_ENEMY                           = 48,
	OFFER_ACCEPTED_GENEROUS                             = 49,
	OFFER_ACCEPTED_STANDARD                             = 50,
	OFFER_ACCEPTED_CLOSE                                = 51,
    OFFER_ACCEPTED_EXTORTION                            = 52,
	OFFER_DECLINED_CLOSE                                = 53,
	OFFER_DECLINED_STANDARD                             = 54,
	OFFER_DECLINED_INSULTING                            = 55,
	OFFER_REJECTED_CLOSE                                = 56,
	OFFER_REJECTED_STANDARD                             = 57,
	OFFER_REJECTED_INSULTING                            = 58,
	OUTRO_DEMEANOUR_BETTER                              = 59,
	OUTRO_DEMEANOUR_NEUTRAL                             = 60,
	OUTRO_DEMEANOUR_WORSE                               = 61,
	DEMEANOUR_DECLARE_UPSET                             = 62,
	DEMEANOUR_DECLARE_ANNOYED                           = 63,
	DEMEANOUR_DECLARE_UNCONCERNED                       = 64,
	DEMEANOUR_REACTION_OFFENDED                         = 65,
	DEMEANOUR_REACTION_DISAPPOINTED                     = 66,
	DEMEANOUR_REACTION_NEUTRAL                          = 67,
    DEMEANOUR_REACTION_NEUTRAL_REJECTION                = 68,
    DEMEANOUR_REACTION_NEUTRAL_REJECTED                 = 69,
	DEMEANOUR_REACTION_PLEASED                          = 70,
	DEMEANOUR_REACTION_ELATED                           = 71,
	NEW_OFFER_WORSE                                     = 72,
	NEW_OFFER_NEUTRAL                                   = 73,
	NEW_OFFER_BETTER                                    = 74,
	OFFER_COUNTERED_CLOSE                               = 75,
	OFFER_COUNTERED_STANDARD                            = 76,
	OFFER_COUNTERED_INSULTING                           = 77,
	OFFER_COUNTERED_OPEN_NEGATIVE                       = 78,
	OFFER_COUNTERED_OPEN_NEUTRAL                        = 79,
	OFFER_COUNTERED_OPEN_POSITIVE                       = 80,
	PRE_RELEASE                                         = 81,
	PRE_RANSOM                                          = 82,
	PRE_EXECUTE                                         = 83,
	PRE_RANSOM_ACCEPT                                   = 84,
	PRE_RANSOM_DECLINE                                  = 85,
	CHARACTER_LEAVING_FACTION_BRIBERY                   = 86,
	CHARACTER_LEAVING_FACTION_MARRIAGE                  = 87,
	CHARACTER_GAINED_MARRIAGE                           = 88,
	CHARACTER_MISSION_SUCCESS                           = 89,
	CHARACTER_MISSION_FAIL                              = 90,
	CHARACTER_MISSION_FAIL_REMOVED                      = 91,
	MISSION_SCROLL                                      = 92,
	MOVEMENT_SABOTAGE                                   = 93,
	BLOCKADE                                            = 94,
};
