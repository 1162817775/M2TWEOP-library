...
void codes::initCodes(int gameVer)
{
	if (gameVer == 1) //kingdoms
	{
		...
		offsets.a_onUnitCreate = 0x008edfc0;
		offsets.a_onMaybeWillSpyOpenGates = 0x004c0bf0;
		offsets.a_onCharacterSwitchFaction = 0x005A1C20;
		offsets.playGameSoundAdd = 0x00a68a10;
		offsets.playCharacterVoiceAdd = 0x00a61650;
		offsets.a_onCreateWife = 0x005a6480;
		offsets.a_onCreateMessageAboutMarriage = 0x00c4ef40;
		offsets.a_onCreateCandidateMarrying = 0x005a6370;
		offsets.a_onDaughterReadyMarryHusband = 0x00c4ee00;
		...
		offsets.a_debugRenderLine = 0xD411E0;
		offsets.debugLineAddFinal = 0xD40A20;
		offsets.a_debugLineAdd = 0xD40860;
		offsets.a_debugRenderPeg = 0xD411F0;
		offsets.a_debugRenderCircle = 0xD41200;
		offsets.a_displayMissileStats = 0x8EA440;
		offsets.a_displayMeleeStats = 0x8EA460;
		offsets.a_displayArmourStats = 0x8EA5D0;
		offsets.a_displayDefenseStats = 0x8EA4F0;
		offsets.a_fleeConstructor1 = 0x5BAE20;
		offsets.a_fleeConstructor2 = 0x5BAF50;
		offsets.getAreaHandle = 0x6426A0;
		offsets.line2dGetClosest = 0xD72980;
		offsets.regionCanHavePort = 0x4A0590;
		offsets.a_onCalculationRatioForBirth = 0x004e9f50;
		offsets.a_onCreateTooltip = 0x00b2fd20;
		offsets.a_onCreateTooltipByCoords = 0x00c34be0;
		offsets.resetTooltipTextAdd = 0x00b2fe30;
		offsets.createArmyByCoords = 0x004f3ff0;
		offsets.attachFortArmy = 0x004c1450;
		offsets.a_onCreateCapabilityUnicodeString = 0x005f5f70;
		offsets.a_onBlockadePort = 0x0059d610;
	...
	else if (gameVer == 2) //steam
	{
		...
		offsets.a_onUnitCreate = 0x008eea40;
		offsets.a_onMaybeWillSpyOpenGates = 0x004c1180;
		offsets.a_onCharacterSwitchFaction = 0x005A2100;
		offsets.playGameSoundAdd = 0x00a69a60;
		offsets.playCharacterVoiceAdd = 0x00a62680;
		offsets.a_onCreateWife = 0x005a6960;
		offsets.a_onCreateMessageAboutMarriage = 0x00c49340;
		offsets.a_onCreateCandidateMarrying = 0x005a6850;
		offsets.a_onDaughterReadyMarryHusband = 0x00c49200;
		...
		offsets.a_debugRenderLine = 0xD3B530;
		offsets.debugLineAddFinal = 0xD3AD70;
		offsets.a_debugLineAdd = 0xD3ABB0;
		offsets.a_debugRenderPeg = 0xD3B540;
		offsets.a_debugRenderCircle = 0xD3B550;
		offsets.a_displayMissileStats = 0x8EAEC0;
		offsets.a_displayMeleeStats = 0x8EAEE0;
		offsets.a_displayArmourStats = 0x8EB050;
		offsets.a_displayDefenseStats = 0x8EAF70;
		offsets.a_fleeConstructor1 = 0x5BB300;
		offsets.a_fleeConstructor2 = 0x5BB430;
		offsets.getAreaHandle = 0x642A50;
		offsets.line2dGetClosest = 0xD6CD00;
		offsets.regionCanHavePort = 0x4A0A30;
		offsets.a_onCalculationRatioForBirth = 0x004ea560;
		offsets.a_onCreateTooltip = 0x00b2a030;
		offsets.a_onCreateTooltipByCoords = 0x00c2efb0;
		offsets.resetTooltipTextAdd = 0x00b2a140;
		offsets.createArmyByCoords = 0x004f45c0;
		offsets.attachFortArmy = 0x004c19e0;
		offsets.a_onCreateCapabilityUnicodeString = 0x005f6360;
		offsets.a_onBlockadePort = 0x0059db00;
